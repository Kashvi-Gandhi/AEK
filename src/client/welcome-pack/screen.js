...
//       const fetchedCampus = await getParticipantType(window.contactid);
...
export default class Screen extends React.Component {
  ...
  async loadUserDetails() {
    ...
    try {
      /*
       * Contact ID is NOT passed here.
       *
       * welcome-pack.ect gets the contact ID
       * directly from CMAuth.
       */
      const fetchedCampus = await getParticipantType();

      console.log(
        "ParticipantType / Campus received:",
        fetchedCampus
      );
      ...
      console.error(
        "Failed to get participant type:",
        error
      );
      ...
      <Container>
        <VBox>
          ...
          <BasicSegment>
            ...
            {loading && (
              <p>
                Getting your campus information...
              </p>
            )}
